...
// configuration step. It creates a namespace called `automatic_succotash`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", automatic_succotash::cmake::project_name, automatic_succotash::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", automatic_succotash::cmake::project_version);
      return EXIT_SUCCESS;
    }
